...
`EASE_IN_QUINT` | Same as `CUSTOM_CUBIC_BEZIER(0.64, 0, 0.78, 0, ...)`. |
`EASE_IN_EXPO` | Same as `CUSTOM_CUBIC_BEZIER(0.7,  0, 0.84, 0, ...)`. |
`EASE_IN_CIRC` | Same as `CUSTOM_CUBIC_BEZIER(0.55, 0, 1, 0.45, ...)`. |
...
`EASE_OUT_SINE` | Same as `CUSTOM_CUBIC_BEZIER(0.61, 1, 0.88, 1, ...)`. |
`EASE_OUT_QUAD` | Same as `CUSTOM_CUBIC_BEZIER(0.5,  1, 0.89, 1, ...)`. |
`EASE_OUT_CUBIC` | Same as `CUSTOM_CUBIC_BEZIER(0.33, 1, 0.68, 1, ...)`. |
`EASE_OUT_QUART` | Same as `CUSTOM_CUBIC_BEZIER(0.25, 1, 0.5, 1, ...)`. |
`EASE_OUT_QUINT` | Same as `CUSTOM_CUBIC_BEZIER(0.22, 1, 0.36, 1, ...)`. |
`EASE_OUT_EXPO` | Same as `CUSTOM_CUBIC_BEZIER(0.16, 1, 0.3, 1, ...)`. |
`EASE_OUT_CIRC` | Same as `CUSTOM_CUBIC_BEZIER(0, 0.55, 0.45, 1, ...)`. |
...
`EASE_IN_OUT_SINE` | Same as `CUSTOM_CUBIC_BEZIER(0.37, 0, 0.63, 1, ...)`. |
`EASE_IN_OUT_QUAD` | Same as `CUSTOM_CUBIC_BEZIER(0.45, 0, 0.55, 1, ...)`. |
`EASE_IN_OUT_CUBIC` | Same as `CUSTOM_CUBIC_BEZIER(0.65, 0, 0.35, 1, ...)`. |
`EASE_IN_OUT_QUART` | Same as `CUSTOM_CUBIC_BEZIER(0.76, 0, 0.24, 1, ...)`. |
`EASE_IN_OUT_QUINT` | Same as `CUSTOM_CUBIC_BEZIER(0.83, 0, 0.17, 1, ...)`. |
`EASE_IN_OUT_EXPO` | Same as `CUSTOM_CUBIC_BEZIER(0.87, 0, 0.13, 1, ...)`. |
`EASE_IN_OUT_CIRC` | Same as `CUSTOM_CUBIC_BEZIER(0.85, 0, 0.15, 1, ...)`. |
