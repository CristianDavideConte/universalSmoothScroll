...
In order to solve it, you have to manually declare the `uss` object by adding the `declare var uss: any` line in you typescript declaration file (the one that ends with `.d.ts`). <br/>
