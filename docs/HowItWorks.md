...
The `universalsmoothscroll-min.js` script will declare and initialize the `uss` object **_as a public property of [`Window`](https://developer.mozilla.org/en-US/docs/Web/API/Window)_**. <br/>
...
The `uss`'s [`variables`](./VariablesAbout.md) are initialized **_after_** the window's [`load event`](https://developer.mozilla.org/en-US/docs/Web/API/Window/load_event) so you should [`wait for it`](https://developer.mozilla.org/en-US/docs/Web/API/Window/load_event#examples) in order to use the API's functionalities. <br/>
These [`variables`](./VariablesAbout.md) **_SHOULD NOT_** be directly manipulated: always use the provided accessors.<br/>
