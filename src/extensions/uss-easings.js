...
import { IS_POSITIVE, IS_IN_0_1, IS_FUNCTION } from '../main/types.js';

import { FACTORIAL } from '../main/math.js';
...
import { getFramesTime, _errorLogger } from '../main/uss.js';
...
export const CUSTOM_BEZIER_CURVE = (xs, ys, duration = 500, callback, options) => {
    ...
    if (!Array.isArray(xs)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_BEZIER_CURVE', { secondaryMsg: xs, idx: 0 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!Array.isArray(ys)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_BEZIER_CURVE', { secondaryMsg: ys, idx: 1 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!IS_POSITIVE(duration)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_BEZIER_CURVE', { secondaryMsg: duration, idx: 3 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
...
export const CUSTOM_CUBIC_BEZIER = (x1 = 0, y1 = 0, x2 = 1, y2 = 1, duration = 500, callback, options) => {
    ...
    if (!IS_IN_0_1(x1)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_CUBIC_BEZIER', { secondaryMsg: x1, idx: 0 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!IS_IN_0_1(y1)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_CUBIC_BEZIER', { secondaryMsg: y1, idx: 1 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!IS_IN_0_1(x2)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_CUBIC_BEZIER', { secondaryMsg: x2, idx: 2 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!IS_IN_0_1(y2)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_CUBIC_BEZIER', { secondaryMsg: y2, idx: 3 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
    ...
    if (!IS_POSITIVE(duration)) {
        _errorLogger(
            CREATE_LOG_OPTIONS(options, 'CUSTOM_CUBIC_BEZIER', { secondaryMsg: duration, idx: 4 }, DEFAULT_LOG_OPTIONS)
        );
        return;
    }
 ...
 */
export const EASE_LINEAR = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0, 0, 1, 1, duration, callback, { subject: 'EASE_LINEAR' });
 ...
 */
export const EASE_IN_SINE = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.12, 0, 0.39, 0, duration, callback, { subject: 'EASE_IN_SINE' });
 ...
 */
export const EASE_IN_QUAD = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.11, 0, 0.5, 0, duration, callback, { subject: 'EASE_IN_QUAD' });
 ...
 */
export const EASE_IN_CUBIC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.32, 0, 0.67, 0, duration, callback, { subject: 'EASE_IN_CUBIC' });
 ...
 */
export const EASE_IN_QUART = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.5, 0, 0.75, 0, duration, callback, { subject: 'EASE_IN_QUART' });
 ...
 */
export const EASE_IN_QUINT = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.64, 0, 0.78, 0, duration, callback, { subject: 'EASE_IN_QUINT' });
...
export const EASE_IN_EXPO = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.7, 0, 0.84, 0, duration, callback, { subject: 'EASE_IN_EXPO' });
 ...
 */
export const EASE_IN_CIRC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.55, 0, 1, 0.45, duration, callback, { subject: 'EASE_IN_CIRC' });
 ...
 */
export const EASE_OUT_SINE = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.61, 1, 0.88, 1, duration, callback, { subject: 'EASE_OUT_SINE' });
 ...
 */
export const EASE_OUT_QUAD = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.5, 1, 0.89, 1, duration, callback, { subject: 'EASE_OUT_QUAD' });
 ...
 */
export const EASE_OUT_CUBIC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.33, 1, 0.68, 1, duration, callback, { subject: 'EASE_OUT_CUBIC' });
 ...
 */
export const EASE_OUT_QUART = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.25, 1, 0.5, 1, duration, callback, { subject: 'EASE_OUT_QUART' });
 ...
 */
export const EASE_OUT_QUINT = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.22, 1, 0.36, 1, duration, callback, { subject: 'EASE_OUT_QUINT' });
 ...
 */
export const EASE_OUT_EXPO = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.16, 1, 0.3, 1, duration, callback, { subject: 'EASE_OUT_EXPO' });
 ...
 */
export const EASE_OUT_CIRC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0, 0.55, 0.45, 1, duration, callback, { subject: 'EASE_OUT_CIRC' });
 ...
 */
export const EASE_IN_OUT_SINE = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.37, 0, 0.63, 1, duration, callback, { subject: 'EASE_IN_OUT_SINE' });
 ...
 */
export const EASE_IN_OUT_QUAD = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.45, 0, 0.55, 1, duration, callback, { subject: 'EASE_IN_OUT_QUAD' });
 ...
 */
export const EASE_IN_OUT_CUBIC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.65, 0, 0.35, 1, duration, callback, { subject: 'EASE_IN_OUT_CUBIC' });
 ...
 */
export const EASE_IN_OUT_QUART = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.76, 0, 0.24, 1, duration, callback, { subject: 'EASE_IN_OUT_QUART' });
 ...
 */
export const EASE_IN_OUT_QUINT = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.83, 0, 0.17, 1, duration, callback, { subject: 'EASE_IN_OUT_QUINT' });
 ...
 */
export const EASE_IN_OUT_EXPO = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.87, 0, 0.13, 1, duration, callback, { subject: 'EASE_IN_OUT_EXPO' });
 ...
 */
export const EASE_IN_OUT_CIRC = (duration, callback) =>
    CUSTOM_CUBIC_BEZIER(0.85, 0, 0.15, 1, duration, callback, { subject: 'EASE_IN_OUT_CIRC' });
...
export const EASE_IN_OUT_BOUNCE = (duration = 1200, bouncesNumber = 6, callback) => {
    ...
    if (bouncesNumber === 2) {
        return CUSTOM_CUBIC_HERMITE_SPLINE(
            [0, 0.04, 0.14, 0.24, 0.3, 0.3001, 0.4, 0.6, 0.7, 0.7001, 0.76, 0.86, 0.96, 1],
