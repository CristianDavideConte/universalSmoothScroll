    ...
    it('Tests the setXStepLengthCalculator method', function () {
        cy.window().then((win) => {
            ...
            cy.testFailingValues(
                ...
                {
                    0: [constants.failingValuesAllNoUnsupportedNoUndefined, [_testElement], [true, false]],
                    1: [
                        [_testCalculatorValidType1, _testCalculatorValidType2, _testCalculatorValidType3],
