    ...
    it('Tests the getMaxScrolls method', function () {
        cy.window().then((win) => {
            ...
            cy.testFailingValues(
                uss.getMaxScrolls,
                {
                    0: [constants.failingValuesNoUndefined, [true, false]],
                },
                ...
                //Test the Window
                expect(uss.getMaxScrolls(win, false)[0]).to.equal(
                    uss.getMaxScrolls(uss.getWindowScroller(win), false)[0]
                );
                expect(uss.getMaxScrolls(win, false)[1]).to.equal(
                    uss.getMaxScrolls(uss.getWindowScroller(win), false)[1]
                );
                expect(uss.getMaxScrolls(win, true)[0]).to.equal(
                    uss.getMaxScrolls(uss.getWindowScroller(win), true)[0]
                );
                expect(uss.getMaxScrolls(win, true)[1]).to.equal(
                    uss.getMaxScrolls(uss.getWindowScroller(win), true)[1]
                );
