    ...
    it('Tests the getAllScrollableParents method', function () {
        cy.window().then((win) => {
            cy.testFailingValues(
                uss.getAllScrollableParents,
                {
                    0: [constants.failingValuesAllNoUndefined, [true, false], constants.failingValuesAllNoUndefined],
                },
                ...
                const _positionFixedElementDirectBodyChild = win.document.getElementById(
                    'position-fixed-element-direct-body-child'
                );
                const _positionAbsoluteElementDirectBodyChild = win.document.getElementById(
                    'position-absolute-element-direct-body-child'
                );
                ...
                //test window
                expect(constants.arraysAreEqual(uss.getAllScrollableParents(win), [])).to.be.true;

                //test html and body
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(win.document.documentElement), [_htmlParent])
                ).to.be.true;
                expect(constants.arraysAreEqual(uss.getAllScrollableParents(_body), [_bodyParent])).to.be.true;

                //test element with position:fixed
                expect(constants.arraysAreEqual(uss.getAllScrollableParents(_positionFixedElementDirectBodyChild), []))
                    .to.be.true;

                //test element with position:fixed
                expect(constants.arraysAreEqual(uss.getAllScrollableParents(_positionFixedElement), [])).to.be.true;

                //test element with position:absolute which is a direct child of body
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_positionAbsoluteElementDirectBodyChild), [
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_positionAbsoluteElementA), [
                        _genericElementParent00,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(constants.arraysAreEqual(uss.getAllScrollableParents(_positionAbsoluteElementB), [_htmlParent]))
                    .to.be.true;

                //test elements with no constraint
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement1), [
                        _genericElementParent11,
                        _genericElementParent12,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement2), [
                        _genericElementParent21,
                        _genericElementParent22,
                    ])
                ).to.be.true;

                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement3), [
                        _genericElementParent31,
                        _genericElementParent32,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement4), [
                        _genericElementParent41,
                        _genericElementParent42,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement5), [
                        _genericElementParent51,
                        _genericElementParent52,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement6, false), [_body, _bodyParent])
                ).to.be.true;

                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement6, true), [
                        _genericElementParent61,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
                ...
                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement7, false), [_body, _bodyParent])
                ).to.be.true;

                expect(
                    constants.arraysAreEqual(uss.getAllScrollableParents(_genericElement7, true), [
                        _genericElementParent71,
                        _body,
                        _bodyParent,
                    ])
                ).to.be.true;
