 ...
 * ]
 */
function _scrollIntoViewTester(resolve, elements = [], i = 0) {
     ...
     * scrollIntoViewTester function to wait for scroll-animations to complete.
     */
                    ...
                    _scrollIntoViewTester(resolve, [
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    //Tests the container position (element's parentElement)
                                    el = el.parentElement;
                                ...
                                (el) => {
                                    //Tests the parent position (container's parentElement)
                    ...
                    _scrollIntoViewTester(resolve, [
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    ...
                                    uss.scrollTo(
                                        uss.getMaxScrollX(_pageScrollerOfWin) / 2,
                                        uss.getMaxScrollY(_pageScrollerOfWin),
                                        _pageScrollerOfWin
                                    );
                        ...
                        },
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    ...
                                    const _parent = _container.parentElement;
                                    uss.scrollTo(
                                        uss.getMaxScrollX(_pageScrollerOfWin),
                                        uss.getMaxScrollY(_pageScrollerOfWin),
                                        _pageScrollerOfWin
                                    );
                        ...
                        },
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    ...
                                    const _container = _nextEl.parentElement;
                                    const _parent = _container.parentElement;
                                    uss.scrollTo(0, uss.getMaxScrollY(_pageScrollerOfWin) / 2, _pageScrollerOfWin);
                        ...
                        },
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    ...
                                    uss.scrollTo(
                                        uss.getMaxScrollX(_pageScrollerOfWin) / 2,
                                        uss.getMaxScrollY(_pageScrollerOfWin) / 2,
                                        _pageScrollerOfWin
                                    );
                                    uss.scrollTo(uss.getMaxScrollX(_parent) / 2, _parent.scrollHeight / 8, _parent);
                                    uss.scrollTo(
                                        _container.scrollWidth / 8,
                                        uss.getMaxScrollY(_container) / 2,
                                        _container
                                    );
                                },
                            ],
                        ...
                        },
                        {
                            ...
                            tests: [
                                ...
                                (el) => {
                                    ...
                                    const _container = _nextEl.parentElement;
                                    const _parent = _container.parentElement;
                                    uss.scrollTo(uss.getMaxScrollX(_pageScrollerOfWin) / 2, 0, _pageScrollerOfWin);
                                    uss.scrollTo(uss.getMaxScrollX(_parent) / 2, _parent.scrollHeight, _parent);
                                    uss.scrollTo(
                                        (_container.scrollWidth * 5) / 8,
                                        uss.getMaxScrollY(_container),
                                        _container
                                    );
                                },
                            ],
