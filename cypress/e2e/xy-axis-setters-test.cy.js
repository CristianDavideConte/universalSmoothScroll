        ...
        cy.window()
            .then((win) => {
                ...
                .then(() => {
                    ...
                    uss.setStepLengthCalculator(_testCalculatorValidType1, uss.getPageScroller(), false);
                    ...
                    uss.setStepLengthCalculator(_testCalculatorValidType2, uss.getPageScroller(), false);
                    ...
                    uss.setStepLengthCalculator(_testCalculatorValidType3, uss.getPageScroller(), false);
                    ...
                    uss.setStepLengthCalculator(_testCalculatorValidType2, uss.getPageScroller(), true);
